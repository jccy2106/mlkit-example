...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Test Image 1 (Text)", "Test Image 2 (Face)", "Test Image 3 (Menu)", "Test Image 4 (Menu)"};
    ...
    public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
            case 2:
                mSelectedImage = getBitmapFromAsset(this, "menu.jpg");
                break;
            case 3:
                mSelectedImage = getBitmapFromAsset(this, "menu2.jpg");
                break;
        }
